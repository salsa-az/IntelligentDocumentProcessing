      ...
      <div v-show="dropdownOpen" class="origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1" :class="align === 'right' ? 'right-0' : 'left-0'">
        ...
        >
          <li class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
            <router-link class="flex items-center py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-700/20" to="#0" @click="dropdownOpen = false">
              <div class="w-8 h-8 rounded-full shrink-0 bg-gradient-to-tr from-gray-500 to-gray-400 mr-3">
                <img class="w-8 h-8 rounded-full" src="../images/user-avatar-32.png" width="32" height="32" alt="Channel 01" />
              </div>
              <div>
                <div class="font-medium text-gray-800 dark:text-gray-100">Channel 01</div>
                <div class="text-xs text-gray-500 dark:text-gray-400">Latest update</div>
              </div>
            </router-link>
          </li>
          <li class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
            <router-link class="flex items-center py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-700/20" to="#0" @click="dropdownOpen = false">
              <div class="w-8 h-8 rounded-full shrink-0 bg-gradient-to-tr from-blue-500 to-blue-400 mr-3">
                <img class="w-8 h-8 rounded-full" src="../images/user-avatar-32.png" width="32" height="32" alt="Channel 02" />
              </div>
              <div>
                <div class="font-medium text-gray-800 dark:text-gray-100">Channel 02</div>
          ...
          <li class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
            <router-link class="flex items-center py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-700/20" to="#0" @click="dropdownOpen = false">
              <div class="w-8 h-8 rounded-full shrink-0 bg-gradient-to-tr from-green-500 to-green-400 mr-3">
                <img class="w-8 h-8 rounded-full" src="../images/user-avatar-32.png" width="32" height="32" alt="Channel 03" />
              </div>
              <div>
                <div class="font-medium text-gray-800 dark:text-gray-100">Channel 03</div>
                <div class="text-xs text-gray-500 dark:text-gray-400">New messages</div>
              </div>
            </router-link>
          </li>
        </ul>
