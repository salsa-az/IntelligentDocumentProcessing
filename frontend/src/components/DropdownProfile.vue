  ...
  <div class="relative inline-flex">
    ...
    >
      <div v-show="dropdownOpen" class="origin-top-right z-10 absolute top-full min-w-44 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1" :class="align === 'right' ? 'right-0' : 'left-0'">
        ...
        >
          <li>
            <router-link class="font-medium text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white flex items-center py-1 px-3" to="/settings/account" @click="dropdownOpen = false">
          ...
          <li>
            <router-link class="font-medium text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white flex items-center py-1 px-3" to="#0" @click="dropdownOpen = false">
              <svg class="w-3 h-3 fill-current text-gray-400 dark:text-gray-500 shrink-0 mr-1" viewBox="0 0 12 12">
          ...
          <li>
            <router-link class="font-medium text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white flex items-center py-1 px-3" to="/signin" @click="dropdownOpen = false">
              <svg class="w-3 h-3 fill-current text-gray-400 dark:text-gray-500 shrink-0 mr-1" viewBox="0 0 12 12">
                <path d="M2 0h8v2H2z" />
              </svg>
              Sign Out
